...
const Contact = () => {
	return (
		<section id="contact">
			<div className="w-full flex flex-col items-center py-24 px-4 lg:px-32">
				...
				<div className="max-w-1/2 bg-gray-800 rounded-xl py-6 px-12 mt-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
					...
					<div className="flex justify-center mt-8">
						<button
							type="button"
							class="text-green-400 bg-gray-900 border border-green-400 hover:bg-gray-800 font-medium rounded-lg text-sm px-4 py-2 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
						>
